            ...
            <div className="p-6 overflow-y-auto prose prose-purple max-w-none">
              <ReactMarkdown
                components={{
                  ...
                  p: ({ children }) => <p className="text-gray-500 mb-4 leading-relaxed">{children}</p>,
                  ul: ({ children }) => <ul className="list-disc list-inside text-gray-500 mb-4 space-y-1">{children}</ul>,
                  ol: ({ children }) => <ol className="list-decimal list-inside text-gray-500 mb-4 space-y-1">{children}</ol>,
