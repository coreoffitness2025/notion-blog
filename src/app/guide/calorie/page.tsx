    ...
    <main className="min-h-screen bg-[var(--corevia-bg)] py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">칼로리 계산기</h1>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 mb-8">
          {/* Gender */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-500 mb-3">성별</label>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-2">체중 (kg)</label>
              <input
                type="number"
                value={weight}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-2">키 (cm)</label>
              <input
                type="number"
                value={height}
          ...
          {/* Activity Level */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-500 mb-3">활동 수준</label>
            <div className="space-y-2">
              {activityLevels.map((level) => (
                ...
                >
                  <span className={activityLevel === level.value ? "text-gray-800" : "text-gray-500"}>
                    {level.label}
                  </span>
          ...
          {/* Goal */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-500 mb-3">목표</label>
            <div className="space-y-2">
              {goals.map((g) => (
                <button
                  key={g.value}
                ...
                >
                  <span className={goal === g.value ? "text-gray-800" : "text-gray-500"}>
                    {g.label}
                  </span>
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center">
                <p className="text-gray-500 text-sm mb-1">기초대사량 (BMR)</p>
                <p className="text-3xl font-bold text-gray-800">{result.bmr}</p>
                <p className="text-gray-500 text-sm">kcal/일</p>
              </div>
              <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center">
                <p className="text-gray-500 text-sm mb-1">총 에너지 소비량 (TDEE)</p>
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
              <h3 className="text-sm font-medium text-gray-500 mb-2">💡 참고사항</h3>
