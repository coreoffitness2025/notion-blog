...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <article className="max-w-3xl mx-auto prose dark:prose-invert">
      ...
      {/* Blog CTA */}
      <div className="not-prose mt-12 p-6 bg-gray-50 rounded-2xl border border-gray-200">
        <p className="text-lg font-bold text-gray-900 mb-2">
          {locale === "ko" ? "오늘 배운 내용을 바로 적용해보세요" : "Put what you learned into practice"}
        </p>
        <p className="text-sm text-gray-500 mb-4">
          {locale === "ko"
            ? "운동 기록, 식단 관리, AI 코치까지 — CoreVia 앱 하나로."
            : "Track workouts, manage nutrition, get AI coaching — all in CoreVia."}
        </p>
        <div className="flex flex-wrap gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-[var(--corevia-primary)] text-white text-sm font-medium px-5 py-2.5 rounded-xl hover:bg-blue-600 transition-colors"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
