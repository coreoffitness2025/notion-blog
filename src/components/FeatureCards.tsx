...
const icons = [
  ...
  (
    <svg key="4" className="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // 바코드 + AI 추정 (QrCode)
  (
    <svg key="5" className="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
