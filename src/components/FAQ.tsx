...
const faqs = [
  ...
  },
  {
    ...
    a: "네! 일반 AI 챗봇과 다르게, CoreVia AI 코치는 내 운동 기록, 식단, 체형 분석 데이터를 실제로 참고해서 개인화된 피드백을 줍니다. 생체 2급 자격 + 피트니스 대회 수상 트레이너가 직접 AI를 튜닝해서, 진짜 PT 경험이 녹아있어요.",
  },
  {
    q: "iOS에서도 쓸 수 있나요?",
  ...
  },
  {
    ...
    a: "생체 2급 자격 트레이너가 직접 튜닝한 AI가 24시간 운동+식단 크로스 피드백을 제공합니다. PT급 전문성을 가진 AI가 내 기록을 실제로 보고 조언해주기 때문에, 비용 부담 없이 꾸준한 PT급 코칭을 받을 수 있어요.",
  },
];
