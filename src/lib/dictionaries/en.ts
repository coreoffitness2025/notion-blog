const en = {
  ...
  hero: {
    title1: "Workouts & Diet, Managed by a Real Online PT.",
    title2: "Built by CoreVia Fitness.",
    subtitle1: "Download now",
    subtitle2: "",
    subtext1: "",
    subtext2: "",
    download: "Download App",
  ...
  team: {
    ...
    missionHeadline: "We relentlessly pursue the Core of fitness,\nand build the most effective Via —\nthe path to mastering it through AI.",
    missionText: "",
