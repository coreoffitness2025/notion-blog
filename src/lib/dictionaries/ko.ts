const ko = {
  ...
  features: {
    ...
    cards: [
      ...
      {
        title: "AI 식단 분석",
        desc: "사진 한 장이면 Gemini AI가 칼로리와 영양소를 즉시 측정해요.\n한국 음식도 정확하게. 바코드 없는 음식은 AI가 추정해줘요",
      },
      {
        title: "운동+식단 크로스 분석",
  ...
  recording: {
    ...
    workoutAlt: "운동 기록 UI",
    dietLabel: "AI 식단 분석",
    dietDesc: "사진 한 장 → Gemini AI가 칼로리/영양소 즉시 측정",
    dietAlt: "식단 기록 UI",
  },
  coach: {
    title: "4가지 성격의 AI 코치",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "AI 식단 분석은 어떻게 해요?",
        a: "음식 사진을 찍으면 Gemini AI가 음식을 인식하고 칼로리와 영양소(탄/단/지)를 즉시 측정해요. 한국 음식도 정확하게 분석하고, 바코드 스캔이나 텍스트 검색으로도 입력할 수 있어요.",
      },
      {
        q: "iOS에서도 쓸 수 있나요?",
