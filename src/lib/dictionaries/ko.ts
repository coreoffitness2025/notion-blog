const ko = {
  ...
  features: {
    ...
    cards: [
      ...
      {
        title: "AI 맞춤 프로그램 추천",
        desc: "목표, 운동 경험, 보유 장비에 맞는 운동 프로그램을 AI가 자동 매칭해줘요",
      },
      {
        title: "바코드 + AI 텍스트 추정",
        desc: "바코드 스캔으로 즉시 영양정보 확인. DB에 없으면 AI가 칼로리를 추정해줘요",
      },
    ],
  },
  recording: {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "트레이너도 사용할 수 있나요?",
        a: "네, 트레이너 전용 모드가 있어요. 회원 관리, 운동/식단 리뷰, 피드백 작성, PT 도구 등 실제 PT 트레이너를 위한 기능을 제공합니다.",
      },
      {
        q: "기록하면 무엇을 얻나요?",
        a: "운동과 식단을 기록하면 포인트가 적립돼요. 포인트로 코치 상점에서 다양한 스킨을 구매해 나만의 코치 외형을 꾸밀 수 있어요. 스트릭 보너스도 있어서 꾸준할수록 더 빨리 모을 수 있어요.",
      },
    ],
  },
  cta: {
  ...
  team: {
    ...
    missionSteps: [
      {
        title: "기록이 근본입니다",
        desc: "대부분의 피트니스 앱은 운동이면 운동, 식단이면 식단만 다룹니다. 하지만 진짜 PT는 둘 다 봐야 합니다. CoreVia는 운동과 식단을 모두 제대로, 쉽게 기록할 수 있도록 설계했습니다.",
      },
      {
