const ko = {
  ...
  features: {
    ...
    description: "피트니스에 있어서 운동과 식단은 개별로 봐야 할 것들이 아닌 철저하게 함께 고려되어야 합니다. 운동과 식단 모두 제대로 기록, 고려하고 당신의 데이터에 맞는 최적의 개인화된 PT 경험을 제공합니다",
  ...
  coach: {
    title: "4가지 성격의 코칭 스타일",
    subtitle: "운동과 식단을 함께 봐주는 코치, 나한테 맞는 스타일을 골라보세요",
    coachAlt: "코치",
    personalities: [
      {
        id: "tough",
  ...
  faq: {
    ...
    items: [
      {
        q: "무료인가요?",
        a: "운동/식단 기록, 진행 그래프, 포인트 적립은 모두 무료예요. 온라인 PT(월 10회)와 음식 분석(월 3회)도 무료로 쓸 수 있어요. 더 많이 사용하려면 Pro 플랜을 추천드려요.",
      },
      {
        q: "진짜 내 기록을 분석해요?",
        a: "네. 단순 기록 앱과 완전히 달라요. 9개의 전문 도구로 운동 기록과 식단을 크로스 분석하고 맞춤 피드백을 줘요.",
      },
      {
        q: "무료와 유료의 차이는?",
        a: "무료: 운동/식단 기록 무제한 + 온라인 PT 월 10회 + 음식 분석 월 3회. Pro: 코칭 기능 무제한 + 루틴 관리 + 바코드 스캔 + 기구 인식. Max: Pro 전체 + 좌우 불균형 분석 + 운동 평가.",
      },
      {
        q: "AI 식단 분석은 어떻게 해요?",
      ...
      },
      {
        ...
        a: "운동과 식단을 동시에 보고 크로스 분석해주고, 16단계 온보딩으로 목표/경험/부상/알레르기까지 반영한 개인화 추천을 해줘요. 24시간 이용 가능한 온라인 PT로 좋은 대안이에요.",
      },
    ],
  },
  cta: {
  ...
  ebook: {
    ...
    subtitle: "피트니스의 핵심",
    description1:
      "근비대와 다이어트는 지식보다 실행과 의지의 문제입니다. 하지만 방법론에 대한 명확한 이해 없이는 지속가능하기 어렵습니다. 핵심을 이해하는 것이 무엇보다 중요하고, 이를 쉽게 하기 위한 스킬이 존재합니다.",
    description2:
      "피트니스 콘텐츠는 같은 지식의 재생산의 연속입니다. 핵심 지식은 이미 정의되어 있고, 쉽게 변하지 않기 때문입니다. 일반인에게 과할 수 있는 프로 레벨의 디테일 대신, 핵심을 알면 대부분의 니즈가 충족됩니다.",
    description3:
      "이 책은 체중 감량과 근비대의 관점에서 무엇을 주안점으로 둘 것인지 명확하게 정리했습니다. 다이어트와 근비대의 근본에서 출발하여 식단/운동 프로그램을 제공하고, 유용한 포인트들과 운동/영양 지식들을 수록했습니다. 이 책이 여러분들의 건강한 일상을 설계하는 데에 기여할 수 있기를 희망합니다.",
    author:
    ...
    introTitle: "이 책에 대하여",
    introParagraphs: [
      "사실 근비대/다이어트라는 것은 지식을 알고 모르고의 차이에 크게 좌우되는 것은 아닙니다. 여러분들도 아시겠지만 근비대나 다이어트는 지식보다는 실행과 의지의 문제입니다. 어쩌면 이미 여러분들은 자기 나름대로의 방법론을 가지고 있을 수 있습니다.",
      "그러나 실행과 의지를 실천함에 있어서 방법론에 대한 명확한 이해가 없다면, 지속 가능하기 어려울 수 있습니다. 따라서 핵심을 이해함이 무엇보다 중요하고, 이를 쉽게 하기 위한 스킬이 존재합니다. 이때 스킬은 핵심을 이해하지 못한 상태라면 의미가 약해질 수 있습니다.",
      "따라서 이 책에서는 일반인의 관점에서 읽기 쉽게, 현재까지 밝혀진 피트니스의 핵심을 정리해보고자 합니다. 현재 피트니스 콘텐츠는 같은 지식의 재생산의 연속입니다. 왜냐하면 피트니스에 필요한 핵심 지식이 이미 사실상 정의되었고, 쉽게 변하지 않기 때문입니다. 여기에 더해 다양한 상술과 방법론들은 사람들을 유혹합니다.",
      "사람이기에 적은 노력으로 본인이 목적하는 바를 찾는 것은 당연하지만, 단언컨대 핵심을 이해하고 요행이 아닌 근본과 정도를 걷는 것이 가장 빠른 길이라고 단언합니다.",
      "누군가에겐 귀중한 정보일 수 있으나 많은 피트니스 관련 콘텐츠가 일반인에게는 어쩌면 과할 수 있는 프로 레벨의 운동 디테일, 식단의 디테일 등을 소개하면서 필요한 정보인 것처럼 우리를 혼란스럽게 하곤 합니다. 심지어 의견이 완전히 대치되는 경우도 빈번합니다. 그러나 평범한 수준에서 탄탄한 몸을 원하는 일반인인 대부분의 사람들은 이런 지식까지 곱씹어가며 알 필요는 없습니다. 핵심을 알면 대부분의 일반인들이 원하는 니즈가 모두 충족됩니다. 따라서 핵심을 이해하는 것이 중요합니다.",
      "이 책은 체중 감량과 근비대의 관점에서 무엇을 주안점으로 둘 것인지에 대해 명확하게 정리했습니다. 우선 다이어트와 근비대의 근본은 무엇인지를 명확하게 하는 것으로 출발하여 이를 토대로 한 식단/운동 프로그램을 제공합니다. 또한 이 과정에서 알아두면 유용한 포인트들과 근본에 살을 붙여나갈 운동/영양 지식들을 수록했습니다. 이 책이 여러분들의 건강한 일상을 설계하는 데에 기여할 수 있기를 희망합니다.",
    ],
    ...
    priceLabel: "전자책 (PDF)",
    price: "₩30,000",
    deliveryNote: "결제 즉시 다운로드",
    nameLabel: "이름",
    namePlaceholder: "실명을 입력해주세요",
    phoneLabel: "전화번호",
    phonePlaceholder: "01012345678",
    watermarkNotice: "구매자 정보가 전자책에 워터마크로 삽입됩니다.",
    buyButton: "구매하기",
    processing: "결제 진행 중...",
  ...
  ebookSuccess: {
    ...
    title: "결제 완료!",
    subtitle: "전자책이 준비되었습니다. 아래 버튼을 눌러 다운로드하세요.",
    downloadButton: "전자책 다운로드",
    generating: "맞춤 전자책을 생성하고 있습니다...",
    doneTitle: "다운로드 완료!",
    doneSubtitle: "즐거운 독서 되세요. 궁금한 점은 언제든 문의해주세요.",
    redownload: "다시 다운로드",
    errorTitle: "오류가 발생했습니다",
    errorInvalid: "잘못된 결제 정보입니다. 다시 시도해주세요.",
    errorConfirm: "결제 확인에 실패했습니다. 고객센터에 문의해주세요.",
    errorDownload: "다운로드에 실패했습니다. 다시 시도해주세요.",
  },
  contact: {
    title: "문의하기",
  ...
  coachPage: {
    badge: "AI Coach",
    title1: "나만의 온라인 PT 코칭을",
    title2: "만나보세요",
    subtitle1: "기록을 빠짐없이 할수록 더 정확한 코칭을 받을 수 있어요.",
    subtitle2: "4가지 성격 중 골라보세요.",
    diffTitle: "일반 기록 앱과 뭐가 달라요?",
    diffs: [
      {
        title: "내 기록을 진짜 봐요",
        desc: "운동 기록, 식단 데이터, 신체 정보까지 — 당신의 데이터를 실제로 분석하고 조언해줘요.",
      },
      {
        title: "운동+식단 같이 봐요",
        desc: "'등 운동 했는데 단백질이 부족해요' — 운동만, 식단만 보는 앱과 달리 둘 다 보고 피드백해줘요.",
      },
      {
        title: "전문가가 직접 만들었어요",
  ...
  metadata: {
    ...
    chatTitle: "온라인 PT 코치와 대화하기",
    chatDesc:
      "코치 케이 · 코치 제인과 실시간 대화. 운동, 식단, 루틴 고민을 상담하세요.",
  },
  chat: {
    metaTitle: "온라인 PT 코치와 대화하기 | CoreVia",
    metaDesc:
      "코치 케이 · 코치 제인, 4가지 성격으로 만나는 온라인 PT 코칭. 운동, 식단, 루틴 고민을 상담하세요.",
